...
public class PeliculasAleatorias extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane5.setViewportView(pelicula2TA);
        ...
        anioCB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                anioCBActionPerformed(evt);
            }
        });
    ...
    private void aniadirBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aniadirBActionPerformed
        ...
        String anio = aniadirTF.getText().substring(aniadirTF.getText().length() - 4, aniadirTF.getText().length());
        int posAniadir;
    ...
    private void anioCBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_anioCBActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_anioCBActionPerformed
